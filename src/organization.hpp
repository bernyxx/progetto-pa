...
public:
	// costruttore
	// richiede nome del team e la lista di organizzazioni dove verr� inserita la squadra
	...
	// restituisce un puntatore al miglior giocatore della squadra -> il giocatore con la pi� alta media del rapporto KD per partita (vedi getAvgKD in Player)
